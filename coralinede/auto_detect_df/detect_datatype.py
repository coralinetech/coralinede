...
class DFDetection:
    ...
    """ 
        Class for Data Type and Data Length Detection of DataFrame
    """

    def get_detected_column_types(self, df):
    ...
    def get_max_length_columns(self, df):
    ...
    def convert_df_datatype_to_sqlalchemy_datatype(self, df):
        ...
        arr_max_len_columns, arr_max_decimal = self.get_max_length_columns(df)
    ...
    def get_datatype_each_col(self, df):
        ...
        df = self.get_detected_column_types(df)

        dtype_dict = self.convert_df_datatype_to_sqlalchemy_datatype(df)
