...
class DFDetectionUtils:
    """
        Utility Class for Data Type and Data Length Detection of DataFrame
    """

    def get_clean_col_and_delimiter(self, file_path):
        """
        ...
        arr_header = self.get_simplify_column_name(first_line, delimiter)

        return arr_header, delimiter


    def get_simplify_column_name(self, column_name, delimiter):
        """
